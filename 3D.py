...
class GraphicEditor:
    ...
    def show_help(self):
        ...
        **Other:**
        ...
        help_label = ttk.Label(help_window, text=help_text, justify=tk.LEFT, font=("Arial", 11))
    ...
    def update_plot(self):
        ...
        self.ax.set_xlim(-10, 10)  # Set fixed axis limits
...
def is_degenerate(x_values, y_values, points):
    ...
    return abs(area) < 1e-6  # Tolerance for numerical errors
